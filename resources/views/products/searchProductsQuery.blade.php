          ...
          <div class="product-block">
            ...
            <div class="image-box mb-16">
              ...
              <a href="{{ url('product-details/' . \Illuminate\Support\Str::slug($product['name']) . '/' . $product['id']) }}">
                ...
                <img
                  src="{{ $product['main_image'] ?? $product['image'] ?? '/images/placeholder.png' }}"
                  alt="{{ $product['name'] }}"
                >
            ...
            <div class="content-box">
              ...
              <a
                href="/product-details/{{ strtolower(
                  preg_replace(
                    '/-+/',
                    '-',
                    preg_replace(
...
const banners = [

  {
    ...
    description:
      "Support your daily health with carefully selected vitamins, minerals, and nutritional supplements."
  },

  {
    ...
    description:
      "Discover weight management, sports nutrition, and wellness products designed for an active lifestyle."
  },
