...
.spinnerX9 {
  ...
  border-top: 2px solid #9eef0b;
  border-radius: 50%;
  animation: spinX9 0.8s linear infinite;
  margin: auto;
}
...
<div
  ...
  <p style="margin:0 0 20px; color:#fff;">
    Slimza is designed to support a healthy lifestyle and should be used in conjunction with a balanced diet and regular
    exercise.
    We recommend consulting a qualified healthcare professional before beginning any new dietary, fitness, or supplement
    programme.
    Individual results may vary and are not guaranteed. Slimza products are not intended to diagnose, treat, cure, or
    prevent any disease.
  </p>
  ...
  <p style="margin:0 0 20px; color:#fff;">
    If you are currently taking medication or have an existing medical condition, please consult your doctor prior to
    using Slimza products.
  ...
  <p style="margin:0 0 20px; color:#fff;">
    ...
    If you have any known <strong style="color:#9eef0b;">allergies</strong>, we strongly advise contacting us before
    placing an order.
  </p>
    ...
    <div class="footer-wrapper pt-48 mb-32">
      <div class="row row-gap-4">
          ...
          <div class="store-desc">
            ...
            <a href="/about-us">
              <p class="white mb-xl-32 mb-lg-0 mb-32">
                At Slimza, we believe that living well should feel simple, empowering, and sustainable. Our mission is
                to provide premium-quality health
            ...
            <ul class="list-unstyled social-link">
              <a href="https://x.com/slimza365?s=11" target="_blank" rel="noopener noreferrer">
                <i class="fa-brands fa-x-twitter" style="color:#fff;"></i>
              </a>

              <a href="https://www.facebook.com/share/18oV7XhWAQ/?mibextid=wwXIfr" target="_blank"
                rel="noopener noreferrer">
                <i class="fab fa-facebook-f" style="color:#fff;"></i>
              </a>

              <a href="https://www.instagram.com/slimza_uk?igsh=MTkweGY4MmdmZ2s2Ng%3D%3D&utm_source=qr" target="_blank"
                rel="noopener noreferrer">
                <i class="fab fa-instagram" style="color:#fff;"></i>
              </a>

              <a href="https://youtube.com/@slimza.co.uk1?si=K_7kvLkNWCK3x9of" target="_blank"
                rel="noopener noreferrer">
                <i class="fab fa-youtube" style="color:#fff;"></i>
              </a>

              <a href="https://www.tiktok.com/@slimza_uk?_r=1&_t=ZN-96vieZKPTIk" target="_blank"
                rel="noopener noreferrer">
        ...
        <div class="col-lg-3 col-md-4">
          <div class="footer-link-block">
            <h5 class="white mb-24">Contact Us</h5>
            ...
            <form method="post" class="newsletter-form" id="newsletterFormX9">
...
document.addEventListener("DOMContentLoaded", function() {
  ...
  const form = document.getElementById("newsletterFormX9");
  ...
  form.addEventListener("submit", function(e) {
    ...
    submitBtn.innerHTML = `<div class="spinnerX9"></div>`;
    ...
    fetch("/subscribe", {
      ...
      .then(data => {
        ...
        setTimeout(() => {
          submitBtn.innerHTML = `
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                        <path d="M19.8283 0.171647C19.6625 0.00586635 19.4138 -0.0451101 19.1963 0.041921L0.368218 7.57308C0.152789 7.65925 0.00853097 7.86441 0.00024974 8.09632C-0.00799243 8.32819 0.121382 8.54308 0.330132 8.64433L7.75465 12.2451L11.3555 19.6697C11.4537 19.8722 11.6588 19.9999 11.8826 19.9999C11.8895 19.9999 11.8965 19.9998 11.9035 19.9995C12.1353 19.9913 12.3406 19.847 12.4267 19.6316L19.9579 0.803599C20.045 0.585943 19.994 0.337389 19.8283 0.171647Z"
                        fill="#1E1F20"></path>
                    </svg>
                `;
