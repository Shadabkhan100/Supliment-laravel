                ...
                <div class="col-lg-3 col-md-6 col-6 header-end">
                  <div class="drop-container">
                    <div class="wrapper-dropdown dark-black" id="dropdown2">
                      <span
                        class="selected-display d-inline-flex align-items-center gap-8"
                        id="destination2"
                      >
                        ...
                        <ul class="main-menu__list">
                          ...
                          <li class="dropdown">
                            ...
                            <ul class="sub-menu">
                              ...
                              <li><a href="coming-soon.html" class="active">Coming soon</a></li>
                            </ul>
                          </li>
                        </ul>
                      </div>
 ...
 <!-- Back To Top Start -->
    ...
    <div class="mobile-nav__wrapper">
      ...
      <div class="mobile-nav__content">
        ...
        <div class="logo-box">
          <a href="index.html" aria-label="logo image"><img src="images/logo.png" alt="" /></a>
        </div>
