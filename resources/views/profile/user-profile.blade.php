        ...
        <div class="userGlassX9 userSideX9">
          ...
          <div class="text-center">
            ...
            <div class="userAvatarWrapperX9">
              ...
              <img id="profilePreviewX9" src="{{ asset($user->avatar) }}" class="userAvatarImgX9">
              @else
              ...
              <button type="button" id="avatarSaveBtnX9" class="avatarSaveBtnX9" style="display:none;">
                <i class="fas fa-check"></i>
              </button>

              <input type="file" id="profilePhotoInputX9" accept="image/*" hidden>
...
<div class="userMenuItemX9 tab-btn position-relative" data-tab="bundle-orders">
    ...
    @endif
            ...
            <a class="userMenuItemX9 text-danger" href="{{ url('/delete-user') }}"
    ...
    <a href="{{ url('/reset-password') }}" class="userBtnX9">
        Change Password
            ...
            <div class="tab-content hideX9" id="subscription">
              ...
              <div class="userInfoBoxX9">
                @include("modules.subscription-view")
              </div>
            </div>
      ...
      <form id="updateProfileFormX9">
        ...
        <div class="row g-4">
          ...
          <div class="col-md-6">
            ...
            <input style="color:white" type="text" class="form-control profileInputX9" name="name"
              value="{{ $user->name }}">
          </div>

          <div class="col-md-6">
            <label style="color:white">Phone</label>
            <input style="color:white" type="text" class="form-control profileInputX9" name="phone"
              value="{{ $user->phone }}">
          </div>

          <div class="col-md-6">
            <label style="color:white">Country</label>
            <input style="color:white" type="text" class="form-control profileInputX9" name="country"
              value="{{ $user->country }}">
          </div>

          <div style="color:white" class="col-md-6">
            <label>Date Of Birth</label>
            <input type="date" class="form-control profileInputX9" name="dob" value="{{ $user->dob }}">
          </div>

          <div style="color:white" class="col-12">
            <label>Address</label>
            <textarea class="form-control profileInputX9" rows="4" name="address">{{ $user->address }}</textarea>
          </div>
        ...
        <div class="drawerFooterX9">
          <button type="submit" class="updateBtnX9" id="updateBtnX9" disabled>
            Update Information
          </button>
        </div>
...
function confirmDeleteAccount() {
  return confirm(
    ...
    "All your orders, cart items, account information, and associated data will be permanently deleted."
  );
}
</script>