...
<section class="hero-banner">
  <div class="container-fluid">
    ...
    <div class="hero-wrapper">
      ...
      <div class="slider-arrows d-sm-flex d-none">
        <a href="javascript:;" class="sm-btn light arrow-btn btn-prev" data-slide="hero-banner-slider">
          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            <path d="M15.1883 19.7337C15.5433 19.3788 15.5433 18.8031 15.1882 18.4481L6.74017 10.0002L15.1883 1.55191C15.5433 1.19694 15.5433 0.621303 15.1882 0.266273C14.8332 -0.0887576 14.2576 -0.0887576 13.9026 0.266273L4.81168 9.35742C4.6412 9.52791 4.54544 9.75912 4.54544 10.0002C4.54544 10.2413 4.64126 10.4726 4.81174 10.643L13.9027 19.7337C14.2576 20.0888 14.8333 20.0888 15.1883 19.7337Z" fill="#141516"/>
          </svg>
        </a>
      ...
      <!-- SLIDER -->
      <div class="hero-banner-slider" id="heroBannerSlider"></div>
        ...
        <div class="hero-slide">
          <div class="w-100 h-100 d-flex flex-column align-items-center justify-content-between gap-64">
            ...
            <div class="row row-gap-4 align-items-end">
              ...
              <!-- DESCRIPTION ONLY -->
              <div class="col-lg-3">
                <p class="mb-32 white text-lg-start text-center">
                  ${banner.description ?? ''}
                </p>
