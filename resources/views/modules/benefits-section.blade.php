          ...
          <div class="container-fluid">
            ...
            <div class="row row-gap-3">
              <div class="col-xl-3 col-lg-4 col-sm-6">
                <div class="benefit-block d-flex flex-column gap-24 p-24">
                  <div class="benefit-icon">
                    <img src="images/quality-icon-3.png" alt="" />
                  </div>
              ...
              <div class="col-xl-3 col-lg-4 col-sm-6">
                <div class="benefit-block d-flex flex-column gap-24 p-24">
                  <div class="benefit-icon">
                    <img src="images/quality-icon-2.png" alt="" />
                  </div>
                  <div class="d-flex flex-column gap-12 black">
                    <h6>Gift Package</h6>
              ...
              <div class="col-xl-3 col-lg-4 col-sm-6">
                <div class="benefit-block d-flex flex-column gap-24 p-24">
                  <div class="benefit-icon">
                    <img src="images/quality-icon-1.png" alt="" />
                  </div>
                  <div class="d-flex flex-column gap-12 black">
              ...
              <div class="col-xl-3 col-lg-4 col-sm-6">
                <div class="benefit-block d-flex flex-column gap-24 p-24">
                  <div class="benefit-icon">
                    <img src="images/quality-icon-4.png" alt="" />
                  </div>
                  <div class="d-flex flex-column gap-12 black">
                    <h6>Easy Returns</h6>
                    <p>
                      Stress-free returns for peace of mind, ensuring your satisfaction with every
                      purchase.
                    </p>
                  </div>
                </div>
