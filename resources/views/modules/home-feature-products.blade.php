...
<section class="newest-section py-40">
  <div class="container-fluid">
    ...
    <!-- PRODUCT GRID -->
    <div class="row row-gap-3" id="productContainer"></div>
        ...
        <div class="col-xl-3 col-lg-4 col-sm-6">
          <div class="product-block">
            ...
            <div class="content-box">
              ...
              <!-- STATIC LABEL (as requested) -->
              <p class="eyebrow mb-12">${product.category_name}</p>

              <a href="product-detail.html?id=${product.id}" class="product-title h6 fw-500 mb-12">
                ${product.name}
              </a>
